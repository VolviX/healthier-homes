...
This guide is organized by **sections** — each broken
into practical topics with every claim tied to peer-reviewed research. You don't need to change
everything at once: skim a section, note the one or two swaps that fit your life, and make them
as things wear out or need replacing. The sections below map what's covered and what's on the
way:
...
Most sections above are still being built. Healthier Homes is open-source and
community-maintained — improving a citation, fixing a fact, or drafting a new page all move it
forward. [Contribute on GitHub →](https://github.com/VolviX/healthier-homes)
